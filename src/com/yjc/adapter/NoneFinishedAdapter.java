...
import com.yjc.adapter.SXQAdapter.ViewHolder;
 ...
 *
 */
public class NoneFinishedAdapter extends BaseAdapter {
	private MyDingdanActivity act;
	private List<NoFinishBean> datas;
	
	public NoneFinishedAdapter(MyDingdanActivity act, List<NoFinishBean> datas) {
		super();
		this.act = act;
		this.datas = datas;
	}
